...
export default async function Page({ params: { lng } }) {
  ...
  for (let i = 0; i < 29; i++) {
    ...
    // const cbKhoiHanhNgay = `chuyen_bay.khoi_hanh_${i}.ngay`;
    // const khoiHanhNgay = t(cbKhoiHanhNgay);

    // console.log(khoiHanhNgay);
          ...
          <div className="flex flex-row items-baseline flex-nowrap bg-gray-100 p-2">
            ...
            <p className="ml-2 font-normal text-gray-500">
              {t(`chuyen_bay.khoi_hanh_${i}.thoi_gian`) +
                " " +
                t(`chuyen_bay.khoi_hanh_${i}.ngay`)}
            </p>
          </div>
          <div className="mt-2 flex justify-start bg-white p-2">
            <div className="flex mx-2 ml-6 h8 px-2 flex-row items-baseline rounded-full bg-gray-100 p-1">
              ...
              <p className="font-normal text-sm ml-1 text-gray-500">
                {t(`chuyen_bay.chi_tiet_them_${i}.hang_ghe`)}
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-row place-items-center p-2">
              ...
              <div className="flex flex-col ml-2">
                <p className="text-xs text-gray-500 font-bold">
                  {t(`chuyen_bay.hang_hang_khong_${i}.ten`)}
                </p>
                <p className="text-xs text-gray-500">
                  {t(`chuyen_bay.hang_hang_khong_${i}.ma_so_chuyen_bay`)}
                </p>
                <div className="text-xs text-gray-500">
                  {t(`chuyen_bay.chi_tiet_them_${i}.muc_luong_hanh_ly`)}
                </div>
              </div>
            </div>
            <div className="flex flex-col p-2">
              ...
              <p className="text-gray-500">
                <span className="font-bold">
                  {t(`chuyen_bay.khoi_hanh_${i}.thanh_pho_short_name`)}
                </span>{" "}
                {t(`chuyen_bay.khoi_hanh_${i}.thanh_pho`)}
              </p>
              <p className="text-gray-500">Zimbabwe</p>
            </div>
            <div className="flex flex-col flex-wrap p-2">
              <p className="font-bold">{t(`chuyen_bay.den_${i}.thoi_gian`)}</p>
              <p className="text-gray-500">
                <span className="font-bold">
                  {t(`chuyen_bay.den_${i}.thanh_pho_short_name`)}
                </span>{" "}
                {t(`chuyen_bay.den_${i}.thanh_pho`)}
              </p>
              <p className="text-gray-500">
                {t(`chuyen_bay.den_${i}.quoc_gia`)}
              </p>
            </div>
          </div>
          <div className="mt-4 bg-gray-100 flex flex-row flex-wrap md:flex-nowrap justify-between items-baseline">
            <div className="flex mx-6 py-4 flex-row flex-wrap">
              ...
              <div className="text-sm mx-2 flex flex-col">
                <p className="">{t("chuyen_bay.Standard_Ticket")}</p>
            ...
            <div className="md:border-l-2 mx-6 md:border-dotted flex flex-row py-4 mr-6 flex-wrap">
              ...
              <div className="text-sm mx-2 flex flex-col">
                <p className="">{t("chuyen_bay.Flexible_Ticket")}</p>
